...
$(document).on('click', '#yaziEklemeIslemi', function (e) {
    ...
    var baslik = $("#eyazibaslik").val();
    var yazii = $("#eyazii").val();
...
$(document).on('click', 'a#markduzenle', function (e) {
    ...
    var tip = $(this).parent().parent().find('td:eq(3)').attr("id");
...
$(document).on('click', 'a#yduzenle', function (e) {
    ...
    $("#sakliID").val(id);
    $("#dyazibaslik").val(baslik);
    $("#dyazii").val(yazii);
    $("#myModal").modal('show');
});
$(document).on('click', '#yaziduzenle', function (e) {

    var baslik = $("#dyazibaslik").val();
    var yazii = $("#dyazii").val();
    var id = $("#sakliID").val();
    $.ajax({
        type: "post",
        url: SITE_URL + "/Admin_Ajax",
